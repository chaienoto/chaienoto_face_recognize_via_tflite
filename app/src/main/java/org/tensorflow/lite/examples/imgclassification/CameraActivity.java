...
import org.tensorflow.lite.examples.imgclassification.tflite.Classifier.Recognition;
...
public abstract class CameraActivity extends AppCompatActivity
  ...
  protected Model model = Model.NATA_MODEL;
  ...
  private boolean isHardwareLevelSupported(
    ...
    int deviceLevel = characteristics.get(INFO_SUPPORTED_HARDWARE_LEVEL);
    if (deviceLevel == INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY) {
  ...
  private String chooseCamera() {
    ...
    try {
      for (final String cameraId : manager.getCameraIdList()) {
        ...
        useCamera2API =
            (facing == LENS_FACING_EXTERNAL)
                || isHardwareLevelSupported(
                    characteristics, INFO_SUPPORTED_HARDWARE_LEVEL_FULL);
  ...
  protected void showResultsInBottomSheet(List<Recognition> results) {
    if (results != null && results.size() >= 1) {
      ...
      if (recognition != null) {
        if (recognition.getConfidence() != null && recognition.getConfidence() > 0.5)
        {
        ...
        {
          recognitionTextView.setText("Can not Recognize this people");
          recognitionValueTextView.setText(
                  String.format("%.2f", (100 * recognition.getConfidence())) + "%");
        }
...
//      }
    ...
    {
      recognitionTextView.setText("I Can't See Any Face");
      recognition1TextView.setText("Come Closer OR Let's me See a Face");
      recognitionValueTextView.setText("");
    }
  }
